...
import {AddLabComponent} from './restaurant/labs/add-lab/add-lab.component'; 
import {ViewLabComponent} from './restaurant/labs/view-lab/view-labs.component';
...

    {
        ...
        children: [
            ...
            },
            {
                path: 'labs',
                children: [
                    {path: 'manageLabs', component: LabsComponent, canActivate: [AuthService]},
                   {path: 'addLab', component: AddLabComponent, canActivate: [AuthService]},
                   {path: 'viewLab/:id', component: ViewLabComponent, canActivate: [AuthService]}
            ...
            },
            {
                path: 'bookings',
                children: [
                    {path: 'manageBookings', component: BookingsComponent, canActivate: [AuthService]},
                   {path: 'addLab', component: AddLabComponent, canActivate: [AuthService]},
                   {path: 'viewLab/:id', component: ViewLabComponent, canActivate: [AuthService]}
